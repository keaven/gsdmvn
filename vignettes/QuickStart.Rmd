...
The boundary crossing probabilities column labelled `Probability` here are under the alternate hypothesis.
...
Now we analyze the individual trials and summarize results.
